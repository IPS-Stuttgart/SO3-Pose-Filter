...
def evaluate_filter_sequence(
    ...
    row = {
        ...
        "observed_error_deg": observed_error_deg(seq.rotations, measurements.observations, measurements.mask),
            ...
            rows.append(
                {
                    ...
                    "smoother_ema_error_deg": float(np.nanmean([r["smoother_ema_error_deg"] for r in result_rows])),
                    "smoother_chordal_error_deg": float(np.nanmean([r["smoother_chordal_error_deg"] for r in result_rows])),
